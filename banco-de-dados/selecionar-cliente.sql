...
SELECT * FROM cliente WHERE salario = 3500 AND administrador = TRUE;

SELECT * FROM cliente WHERE salario = 3500 OR administrador = TRUE;

SELECT * FROM cliente WHERE NOT (salario <= 2500);
